...
<html data-bs-theme="light" lang="en">
    ...
    <div class="container-fluid"><a class="navbar-brand" href="index.php"><img
      ...
      <div class="collapse navbar-collapse align-items-center" id="navcol-1">
        ...
        <h1 style="text-align: center;color: var(--bs-body-bg);font-family: Audiowide, serif;">Add Accommodation</h1>
        <div></div>
        <div class="container">
            <form action="addAccommodation.php" method="POST">
                <div class="card shadow mb-3 p-5">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Accommodation Details</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-8 col-lg-8 col-lg-12">
                                <div class="mb-3"><label class="form-label" for="service_name"><strong>Travel
                                            Plan&nbsp;</strong></label><select class="form-select col-lg-8" name="plan">
                                        <optgroup label="Choose a travel plan">
                                            <?php
                                            $rs = $plan->getDestinationName();
                                            foreach ($rs as $plans) {
                                                ?>
                                                <option value="<?php echo $plans['destination_id']; ?>"><?php echo $plans['name']; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </optgroup>
                                    </select></div>
                                <div class="mb-3"><label class="form-label" for="service_name"><strong>Accommodation
                                            Name</strong></label><input class="form-control" type="text" id="service_name"
                                                                placeholder="Accommodation Name" name="accommodationName" required=""></div>
                            </div>
                            <div class="col">
                                <div class="mb-3"><label class="form-label" for="service_price"><strong>Price
                                            *&nbsp;</strong></label><label class="form-label" for="service_price"
                                                                   ...
                                                                   class="form-control" type="text" id="service_price-2" placeholder="Rs.0"
                                                                   name="price" required=""></div>
                                <div class="mb-3"><label class="form-label"
                                                         for="service_price"><strong>Type</strong></label><label class="form-label"
                                                         for="service_price" style="font-size: 11px;"></label><input class="form-control"
                                                         type="text" id="service_price-5" placeholder="" name="type" value="Luxery" name="client_phone" readonly="">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3"></div>
                ...
                <div class="text-end mb-3"><button class="btn btn-primary btn-lg" type="submit">Add Accommadation</button>
                </div>
            </form>
            ...
            if (isset($_GET['success'])) {
                ...
                if ($_GET['success'] == 1) {
                    ...
                    <script>
                        swal("Successfully!", "Added Accommodation!", "success");
                    </script>
                    <?php
                }
            }
