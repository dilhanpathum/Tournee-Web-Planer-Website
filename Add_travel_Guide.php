...
<html data-bs-theme="light" lang="en">
    ...
    <div class="container-fluid"><a class="navbar-brand" href="index.php"><img
      ...
      <div class="collapse navbar-collapse align-items-center" id="navcol-1">
        ...
        <h1 style="text-align: center;color: var(--bs-body-bg);font-family: Audiowide, serif;">Add Travel Guide</h1>
        <div>
            <div class="container">
                <form action="addguide.php" method="POST">
                    <div class="card shadow mb-3 p-5">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Travel Guider Details</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-8 col-lg-8 col-lg-12">
                                    <div class="mb-3"><label class="form-label" for="service_name"><strong>Travel Guider
                                                Name</strong></label><input class="form-control" type="text"
                                                                    id="service_name" placeholder="Full Name" name="guiderName" required=""></div>
                                    <div class="mb-3"><label class="form-label"
                                                             for="service_name"><strong>Email</strong></label><input class="form-control"
                                                             type="text" id="service_name-1" placeholder="Email" name="email"
                                                             required=""></div>
                                    <div class="mb-3"><label class="form-label" for="service_name"><strong>Contact
                                                Number</strong></label><input class="form-control" type="tel"
                                                                      id="service_name-2" placeholder="Contact Number" name="contactNo" required="">
                                    </div>
                                    <div class="mb-3"><label class="form-label"
                                    for="service_price"><strong>Service Charge</strong></label><label class="form-label"
                                    for="service_price" style="font-size: 11px;"></label><input class="form-control"
                                    type="text" id="service_price-5" placeholder="Rs.0" name="charge" >
                            </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="text-end mb-3"><button class="btn btn-primary btn-lg" type="submit">Add Travel
                            Guide</button></div>
                </form>
                ...
                if (isset($_GET['success'])) {
                    ...
                    if ($_GET['success'] == 1) {
                        ...
                        <script>
                                swal("Successfully!", "Added Tour Guide!", "success");
                        </script>
                        <?php
                    }
                }
